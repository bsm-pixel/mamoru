...
import {
  ...
  MoreHorizontal, X, Boxes, Star, Building2, Handshake, PackageOpen,
  type LucideIcon,
} from 'lucide-react';
...
const iconMap: Record<string, LucideIcon> = {
  LayoutDashboard, ShoppingCart, MessageSquare, Wrench, Store,
  FileSignature, Package, Settings, Users, Truck, BarChart3, Boxes, Star, Building2, Handshake, PackageOpen,
};
