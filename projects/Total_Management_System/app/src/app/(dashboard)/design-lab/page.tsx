...
export default function DesignLabPage() {
  return (
    <>
      ...
      <div className="px-6 py-6 space-y-8 max-w-[1100px] mx-auto">
        {/* 헤더 안내 */}
        ...
        {/* 빈 상태 — 진행 중 작업 없음 */}
        <section className="border-2 border-dashed border-neutral-300 rounded-xl p-12 text-center bg-neutral-50">
          <div className="text-4xl mb-3">🎨</div>
          <h3 className="text-base font-bold text-neutral-700 mb-2">진행 중인 디자인 작업 없음</h3>
          <p className="text-xs text-neutral-500 max-w-md mx-auto leading-relaxed">
            새 페이지 디자인 검토가 필요하면 클로드에게 한 마디 하세요.
            <br />
            <span className="font-semibold text-neutral-700">&quot;디자인 모니터에 § XXX 추가해줘&quot;</span>
            <br />
            → 비교 옵션 3~4개가 여기에 렌더됩니다.
          </p>
          <div className="mt-5 text-[11px] text-neutral-400 space-y-1 text-left max-w-sm mx-auto">
            <p>운영 룰:</p>
