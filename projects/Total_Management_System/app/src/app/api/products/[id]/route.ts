...
export async function PATCH(
  ...
  try {
    ...
    const allowed = ['name', 'category', 'price', 'price_dealer', 'price_academy', 'price_purchase', 'price_groups', 'dealer_name', 'academy_name', 'stock_quantity', 'supplier_id', 'description', 'imweb_product_no', 'barcode', 'image_url', 'is_active', 'product_group'];
