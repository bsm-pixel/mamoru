...
| 항목 | 의존성 | 우선순위 |
|------|--------|----------|
| 솔라피 복원수리 5종 템플릿 등록 + 검수 | 솔라피 관리자 작업 | 높음 |
| Make Router에 복원수리 5종 분기 추가 | 솔라피 검수 완료 후 | 높음 |
| GAS Script Properties 설정 (TMS_REPAIR_SYNC_URL 등) | 없음 | 높음 |
| 복원수리 E2E 전체 플로우 검증 | GAS 설정 + 솔라피 완료 후 | 높음 |
