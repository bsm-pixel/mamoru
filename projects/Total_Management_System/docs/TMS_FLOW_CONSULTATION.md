# 상담관리 프로세스 흐름도
> 최종 업데이트: 2026-03-24 (상세 슬라이드 패널 + IA v2 개편)
...
| 항목 | 의존성 | 우선순위 |
|------|--------|----------|
| ~~Make Router 17개 분기 연결~~ | ~~완료~~ | ~~✅ 03-12~~ |
| ~~BC 메타데이터 제거 후 솔라피 재검수~~ | ~~완료~~ | ~~✅ 03-19~~ |
| 모바일 오늘 일정 요약 바 | 없음 | 높음 |
| 인라인 액션 → 패널 내부로 이동 | 없음 | 높음 |
| 서브탭 축소 (매장 3→2 / 출장 4→2 / 톡 4→2) | 없음 | 중간 |
| 출장 모바일 네비 버튼 리스트 항상 표시 | 없음 | 중간 |
| 대응필요 건수 뱃지 | 없음 | 낮음 |
