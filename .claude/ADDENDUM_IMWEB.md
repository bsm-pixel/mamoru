...
- PC (768px+):
  ...
  - **PC 레이아웃 수치 기준 (2026-03-10 확정)**:
    - 페이지 컨테이너: `max-width: 780px` (카드/그리드 혼합 페이지 기준)
    - 탭 콘텐츠 영역: `max-width: 700px`
    - CTA 영역: `max-width: 680px`
    - 섹션 패딩: `64px 40px` (모바일은 48px 24px)
    - 텍스트 전용 페이지(블로그/읽기형)는 640~720px 허용
