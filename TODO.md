...
> 최종 수정: 2026-03-24 (IA v2 + 대시보드 개편 + 상담 슬라이드 패널)
...
#### [최우선] 상담관리 잔여 (#2~#6)
- [ ] #2 모바일 오늘 일정 요약 바 (상단 "오늘 N건" + 터치 펼침)
- [ ] #3 인라인 액션 → 슬라이드 패널 내부로 이동 (행은 클릭만)
- [ ] #4 서브탭 축소: 매장 3→2 / 출장 4→2 / 톡 4→2
- [ ] #5 출장 모바일: 주소+네비 버튼 리스트에 항상 표시
- [ ] #6 대응필요 건수 뱃지 (탭 옆 빨간 숫자)

#### 주문관리
- [ ] 주문 상세 → 슬라이드 패널 (현재 풀페이지 전환)
- [ ] 취소/환불 UI 개선 (현재 복잡)
- [ ] 배송 추적 상세 인라인 표시
